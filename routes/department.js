...
router.put('/update/:id', CheckLogin, CheckRole(['Manager', 'admin']), departmentController.updateDepartment);
router.delete('/delete/:id', CheckLogin, CheckRole(['Manager', 'admin']), departmentController.deleteDepartment);
